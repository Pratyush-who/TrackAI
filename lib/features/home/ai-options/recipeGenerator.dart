...
class _RecipegeneratorState extends State<Recipegenerator>
  ...
  Future<void> _generateRecipe() async {
    ...
    try {
      // Initialize Gemini AI with free model using .env
...
''';
  ...
  Future<void> _saveRecipeToFirebase(Map<String, dynamic> recipeData) async {
    try {
      final user = FirebaseAuth.instance.currentUser;
      if (user != null) {
        // Delete existing recipe to keep only one
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: DropdownButtonFormField<String>(
                                ...
                                items: _cuisineTypes.map<DropdownMenuItem<String>>((String value) {
                          ...
                          child: _isGenerating
                              ...
                              : const Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(width: 8),
                                    Text('Generate Recipe', style: TextStyle(fontSize: 16)),
                                  ],
                                ),
                        ),
                      ),
