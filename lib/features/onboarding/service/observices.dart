...
class OnboardingService {
  ...
  static Future<void> saveOnboardingData(
    ...
    try {
      ...
      // Save to onboardingDetails collection
      await _firestore
          .collection('users')
          .doc(currentUser.uid)
      ...
      // Also update the main user document with onboarding completion status
  ...
  static Future<void> updateOnboardingData(Map<String, dynamic> updates) async {
    try {
      ...
      print('OnboardingService: Onboarding data updated successfully');
    } catch (e) {
