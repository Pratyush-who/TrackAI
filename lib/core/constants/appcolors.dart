...
class AppColors {
  ...
  static const Color darkAccent = Color.fromRGBO(99, 207, 137, 1.0);
  ...
  static List<Color> primaryGradient(bool isDark) => isDark ? darkPrimaryGradient : lightPrimaryGradient;
  static List<Color> backgroundGradient(bool isDark) => isDark ? darkBackgroundGradient : lightBackgroundGradient;
  static List<Color> cardGradient(bool isDark) => isDark ? darkCardGradient : lightCardGradient;
  static List<Color> accentGradient(bool isDark) => isDark ? darkAccentGradient : lightAccentGradient;
  ...
  static Color shimmerBase(bool isDark) => isDark ? Color.fromRGBO(40, 40, 40, 1.0) : Color(0xFFE0E0E0);
  static Color shimmerHighlight(bool isDark) => isDark ? Color.fromRGBO(60, 60, 60, 1.0) : Color(0xFFF5F5F5);
  
  // Bottom Navigation Colors
  static const Color bottomNavSelected = Color.fromRGBO(99, 207, 137, 1.0);
  static Color bottomNavUnselected(bool isDark) => isDark ? Color.fromRGBO(128, 128, 128, 1.0) : Color(0xFF9E9E9E);
  
  // Input Field Colors
  static Color inputFill(bool isDark) => isDark ? Color.fromRGBO(40, 40, 40, 1.0) : Color(0xFFF5F5F5);
